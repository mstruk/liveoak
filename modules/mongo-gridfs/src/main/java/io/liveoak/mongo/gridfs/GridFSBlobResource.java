 ...
 */
public class GridFSBlobResource extends GridFSResource implements BinaryResource {
    ...
    public void readContent(RequestContext ctx, BinaryContentSink sink) throws Exception {
        ...
        // TODO implement this properly ... this is just a prototype

        // get tmp file
        File tmpFile = getTempFile();

        // copy from db to file first
        // TODO - check that we use a worker thread for this
    ...
    public void updateProperties(RequestContext ctx, ResourceState state, Responder responder) throws Exception {
        ...
        // that's nasty
        // we really expect LazyResourceState regardless of Content-Type
        // not cool
    ...
    public String toString() {
        return "[GridFSBlobResource: id=" + this.id() + "]";
    }
}
