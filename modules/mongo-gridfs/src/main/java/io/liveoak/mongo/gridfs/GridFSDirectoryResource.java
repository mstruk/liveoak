...
public class GridFSDirectoryResource extends GridFSResource {
    ...
    public GridFSDirectoryResource(RequestContext ctx, GridFSDirectoryResource parent, String id) {
        super(ctx, parent, id, null, null);
    }
    ...
    public String toString() {
        return "[GridFSDirectoryResource: id=" + this.id() + "]";
    }
}
