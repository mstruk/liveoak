...
public class PgSqlReadCollectionTest extends BasePgSqlTest {
    ...
    public void testReadCollection() throws Exception {
        ...
        checkMember(members.get(0), new Object[]{
                ...
                "total", 18990L,
                "addresses", new URI("/testApp/" + BASEPATH + "/addresses/1")}); // TODO: addresses should return a {self: {href: '...'}}
        ...
        checkMember(members.get(1), new Object[]{
                ...
                "total", 43800L,
                "addresses", new URI("/testApp/" + BASEPATH + "/addresses/2")}); // TODO: addresses should return a {self: {href: '...'}}
